                        ...
                        <div class="prediction-card">
                            <div class="prediction-item">
                                ...
                                <div class="prediction-value"
                                    ...
                                    {{ (result.prediction ?? 0) === 1 ? 'Hypertension' : 'No Hypertension' }}
                                </div>
                            </div>
...
const buildFilterParams = () => {
    ...
    const mustFields = ["gender", "age", "diabetes", "heart_disease", "smoking_history", "bmi", "HbA1c_level", "blood_glucose_level"] as const
...
const predict = async () => {
    ...
    const res = await request.post("/api/predict", data, { disease: "hypertension" });
    if (res.status !== 200) {
