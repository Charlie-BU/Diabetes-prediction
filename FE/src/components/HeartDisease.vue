                        ...
                        <div class="prediction-card">
                            <div class="prediction-item">
                                ...
                                <div class="prediction-value"
                                    ...
                                    {{ (result.prediction ?? 0) === 1 ? 'Heart Disease' : 'No Heart Disease' }}
                                </div>
                            </div>
...
const buildFilterParams = () => {
    ...
    const mustFields = ["gender", "age", "hypertension", "diabetes", "smoking_history", "bmi", "HbA1c_level", "blood_glucose_level"] as const
...
const predict = async () => {
    ...
    const res = await request.post("/api/predict", data, { disease: "heartdisease" });
    if (res.status !== 200) {
